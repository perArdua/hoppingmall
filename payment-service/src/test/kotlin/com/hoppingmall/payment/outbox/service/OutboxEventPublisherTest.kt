...
class OutboxEventPublisherTest {
    ...
    @Test
    fun 발행_성공_후_status를_PUBLISHED로_저장한다() {
        ...
        val sendResult: SendResult<String, Any> = SendResult(
            ProducerRecord("payment", "1", avroRecord as Any),
            RecordMetadata(TopicPartition("payment", 0), 5L, 0, System.currentTimeMillis(), 0, 0)
        )
        ...
        whenever(kafkaTemplate.send(event.topic, event.partitionKey ?: "", avroRecord))
